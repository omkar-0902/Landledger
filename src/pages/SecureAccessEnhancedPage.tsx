...
export function SecureAccessEnhancedPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden bg-surface-container-lowest text-on-surface selection:bg-primary/30">
      ...
      <div className="fixed inset-0 pointer-events-none opacity-40" style={{ backgroundImage: "linear-gradient(rgba(122, 212, 229, 0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(122, 212, 229, 0.05) 1px, transparent 1px)", backgroundSize: "60px 60px", maskImage: "radial-gradient(circle at center, black, transparent 80%)" }} />
      <div
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-[15%] left-[10%] w-2 h-2 bg-primary/30 rounded-full blur-sm" style={{ animation: "landledger-float2 8s ease-in-out infinite" }} />
        <div
          className="absolute top-[65%] right-[15%] w-3 h-3 bg-tertiary/20 rounded-full blur-md"
          style={{ animation: "landledger-float2 8s ease-in-out infinite", animationDelay: "-2s" }}
        />
        <div
          className="absolute bottom-[25%] left-[25%] w-1.5 h-1.5 bg-primary/15 rounded-full"
          style={{ animation: "landledger-float2 8s ease-in-out infinite", animationDelay: "-4s" }}
        />
        <div
          className="absolute top-[40%] left-[80%] w-2 h-2 bg-primary/20 rounded-full blur-sm"
          style={{ animation: "landledger-float2 8s ease-in-out infinite", animationDelay: "-6s" }}
        />
      </div>
      ...
      <main className="flex-grow flex items-center justify-center relative px-6 py-12">
        <div className="w-full max-w-lg relative">
          ...
          <div className="rounded-lg overflow-hidden relative shadow-2xl border border-primary/10 bg-surface-container-low/45 backdrop-blur-3xl hover:border-primary/30 transition-all duration-500">
            <div
            ...
            <div className="p-10 md:p-12">
              ...
              >
                <div className="space-y-2">
                  ...
                  <div className="relative rounded-md transition-shadow duration-300 focus-within:shadow-[0_0_15px_rgba(122,212,229,0.1)]">
                ...
                <div className="pt-6">
                  <button
                    className="w-full group relative py-4 bg-gradient-to-r from-primary via-primary-container to-primary text-on-primary font-bold rounded-md shadow-xl overflow-hidden active:scale-[0.98] transition-all duration-200 font-headline tracking-widest flex items-center justify-center gap-3"
                    style={{ backgroundSize: "200% 200%", animation: "landledger-grad-shift 4s ease infinite" }}
                    type="submit"
                  >
